...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { path: "/factories", icon:< GiFactory size={28}/>, label:"Factory" }
  ];
    ...
    <div className="w-28 min-h-screen bg-gray-600 flex flex-col justify-between py-4">
      ...
      <div className="flex flex-col items-center">
        <button
          ...
          className="w-full flex flex-col items-center justify-center py-20 text-center text-black hover:bg-green-100 transition"
        >
          <TbLogout size={28} />
